                    ...
                    <ul id="projectList" class="flex flex-col gap-1 hidden">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($projects = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<div onclick="deleteProject()" title="Delete this project" class="z-2 flex w-8 h-8 container ml-auto rounded-tr-lg rounded-br-lg hover:bg-slate-300"><svg class="flex w-4 h-4 mx-auto my-auto fill-slate-400 opacity-0 group-hover:opacity-100 group-hover:transition group-hover:duration-500 group-hover:ease-out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M135.2 17.7C140.6 6.8 151.7 0 163.8 0H284.2c12.1 0 23.2 6.8 28.6 17.7L320 32h96c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 96 0 81.7 0 64S14.3 32 32 32h96l7.2-14.3zM32 128H416V448c0 35.3-28.7 64-64 64H96c-35.3 0-64-28.7-64-64V128zm96 64c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16zm96 0c-8.8 0-16 7.2-16 16V432c0 8.8 7.2 16 16 16s16-7.2 16-16V208c0-8.8-7.2-16-16-16z"/></svg></div>';
                                echo '</li>';
                            }
                        }
                        ?>
