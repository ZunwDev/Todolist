...
$(document).on("click", ".prioritySaveBtn", function () {
  boardManager.savePriority($(this).data("priority-id"), $(this).data("priority-name"));
});
...
function confirmDelete(id, delReason) {
  const links = {
    projDel: "https://xtodolist.tode.cz/src/scripts/project/deleteProject.php",
    colCl: "https://xtodolist.tode.cz/src/scripts/board/clearColumn.php",
    colDel: "https://xtodolist.tode.cz/src/scripts/board/deleteColumn.php",
    taskDel: "https://xtodolist.tode.cz/src/scripts/task/deleteTask.php",
    usDel: "https://xtodolist.tode.cz/src/scripts/dashboard/deleteUser.php",
  };
