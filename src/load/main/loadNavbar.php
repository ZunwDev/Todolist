...
echo '<svg class="w-4 h-4 mx-auto fill-black" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 448 512">';
...
if (!isset($_SESSION['login_user'])) {
    echo '<a href="https://xtodolist.tode.cz/src/auth/login.php" type="button" class="h-fit w-fit px-1 py-1 hover:bg-slate-100 transition ease-out duration-200 rounded-lg break-normal font-bold">Log in</a>';
    echo '<a href="https://xtodolist.tode.cz/src/auth/signup.php" type="button" class="h-fit w-fit px-1 py-1 bg-blue-500 hover:bg-blue-400 transition ease-out duration-200 rounded-lg break-normal font-bold text-white">Sign Up</a>';
} else {
    if ($adminState != null) {
