...
echo '    </div>';
echo '    <div title="Delete this column" class="columnDeleteBtn flex flex-row bg-slate-50 py-0.5 hover:bg-slate-200 transition cursor-pointer" data-board-id="' . $boardID . '" onclick="showColumnDeleteWarning(' . $boardID . ')">';
