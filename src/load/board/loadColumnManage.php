...
echo '      <div class="columnEditBtn flex flex-row py-0.5 bg-slate-50 hover:bg-slate-100 cursor-pointer" data-board-id="' . $boardID . '">';
...
echo '      </div>';
echo '      <div title="Clear this column" class="columnClearBtn flex flex-row bg-slate-50 py-0.5 hover:bg-slate-100 transition cursor-pointer" data-board-id="' . $boardID . '">';
...
echo '    </div>';
echo '    <div title="Delete this column" class="columnDeleteBtn flex flex-row bg-slate-50 py-0.5 hover:bg-slate-100 transition cursor-pointer" data-board-id="' . $boardID . '" onclick="showColumnDeleteWarning(' . $boardID . ')">';
