...
echo '            <button title="Cancel - Esc" type="button" class="mt-4 py-1 px-3 mb-3 bg-slate-200 rounded-lg border border-slate-300 hover:bg-slate-300" onclick="closeAnyPopup()">';
echo '                Cancel';
echo '            </button>';
echo '            <button title="Add - Enter" type="button" class="mt-4 py-1 px-3 mb-3 bg-slate-500 text-white rounded-lg border border-slate-400 hover:bg-slate-600" onclick="acceptProjectCreate()">';
echo '                Add';
echo '            </button>';
echo '        </div>';
echo '    </form>';
