...
<div class="flex-1 userList flex flex-col gap-4 lg:mx-auto w-1/2 flex-shrink-0">
    <div class="flex flex-row">
        ...
        <div class="sBar flex flex-row ml-auto">
            ...
            ?>
            <input type="text" class="search flex form-control px-2 rounded-tl-lg rounded-bl-lg border border-slate-300 text-sm focus:outline-none" placeholder="Search <?php echo $userCount; ?> users..."></input>
            <button class="searchBtn rounded-tr-lg rounded-br-lg bg-slate-200 hover:bg-slate-300 mx-auto px-3"><svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.3.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
