...
echo '    <div class="setCheckmark flex flex-row py-0.5 w-48 bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '">';
...
echo '        </div>';
echo '    <div class="taskEditBtn flex flex-row py-0.5 ml bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '">';
...
echo '        </div>';
echo '    <div class="moveTaskPopupBtn flex flex-row py-0.5 bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '" >';
...
echo '        </div>';
echo '    <div title="Delete this task" class="taskDeleteBtn flex flex-row py-0.5 bg-slate-100 hover:bg-slate-200 transition cursor-pointer" data-data-id="' . $dataID . '">';
