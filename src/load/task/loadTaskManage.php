...
echo '    <div class="setCheckmark flex flex-row py-1 w-48 bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '">';
...
echo '        </div>';
echo '    <div class="taskEditBtn flex flex-row py-1 ml bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '">';
...
echo '        </div>';
echo '    <div class="moveTaskPopupBtn flex flex-row py-1 bg-slate-100 hover:bg-slate-200 cursor-pointer" data-data-id="' . $dataID . '" >';
...
echo '        </div>';
echo '    <div title="Delete this task" class="taskDeleteBtn flex flex-row py-1 bg-slate-100 hover:bg-slate-200 transition cursor-pointer" data-data-id="' . $dataID . '">';
...
echo '            <div class="flex text-sm pl-2 py-1 text-red-600">Delete task</div>';
echo '        </div>';
echo '    </div>';
echo '</div>';
