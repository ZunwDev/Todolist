...
echo '              <div title="Add priority" id="priorityButton" class="flex h-fit w-fit px-1 py-1 hover:bg-slate-200 rounded-lg cursor-pointer" onclick="showPriorityPopup()">';
...
if ($priority !== "None") {
    echo '              <div id="priorityList" class="flex w-fit ml-2 h-fit rounded-lg border border-transparent ' . $priority_color . '" onclick="showPriorityPopup()">';
    echo '                  <div id="priorityListText" class="flex mx-auto px-2 cursor-pointer">' . $priority . '</div>';
    echo '              </div>';
} else {
    echo '              <div id="priorityList" class="flex w-fit ml-2 h-fit rounded-lg border border-transparent bg-transparent" onclick="showPriorityPopup()">';
