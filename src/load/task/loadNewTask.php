...
echo '    <div title="Add priority" id="priorityButton" class="priorityMenu flex ml-1 my-1 h-fit w-fit px-1 py-1 hover:bg-slate-300 rounded-lg cursor-pointer">';
...
echo '    </div>';
echo '    <div id="priorityList" class="priorityMenu flex w-fit ml-4 h-fit my-1 rounded-lg border border-transparent bg-transparent">';
echo '      <div id="priorityListText" class="flex mx-auto px-2 cursor-pointer"></div>';
echo '    </div>';
echo '  </div>';
echo '</div>';
echo '<div class="flex flex-row gap-2">';
echo '<div class="cancelTaskBtn flex h-8 w-full bg-red-400 hover:bg-red-500 rounded-md cursor-pointer" data-board-id="' . $boardID . '">';
echo '  <div class="flex mx-auto my-auto">Cancel</div>';
echo '</div>';
echo '  <div class="saveTaskBtn flex h-8 w-full bg-lime-400 hover:bg-lime-500 rounded-md cursor-pointer" data-board-id="' . $boardID . '">';
