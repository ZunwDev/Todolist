...
echo ' <div id="popupElement" class="flex flex-col w-80 h-fit top-28 bg-slate-50 shadow-xl absolute left-0 right-0 ml-auto mr-auto rounded-lg">';
...
echo '  <div class="flex flex-row gap-2 py-2 ml-auto mr-2">';
...
echo '    <div class="w-fit h-fit px-3 py-1 bg-slate-500 border border-slate-400 hover:bg-slate-600 rounded-lg cursor-pointer text-slate-50" onclick="confirmDelete(`' . $id . '`, `' . $reason . '`)">Delete</div>';
echo '  </div>';
echo '</div>';
echo '</div>';
