...
echo '    <div class="flex flex-row my-1 mx-2 bg-slate-100 hover:bg-slate-200 cursor-pointer rounded-md" onclick="showTaskEditPopup(`'.$dataID.'`, `'.$projectName.'`)">';
...
echo '        </div>';
echo '    <div class="w-3/4 flex h-0.5 mx-auto bg-slate-200"></div>';
echo '    <div title="Delete this task" class="flex flex-row mt-1 mx-2 bg-slate-100 hover:text-red-500 transition cursor-pointer rounded-md group" onclick="deleteTask('.$dataID.', '.$projectName.')">';
