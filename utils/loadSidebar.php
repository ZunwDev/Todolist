...
if (mysqli_num_rows($result) > 0) {
    while ($projects = mysqli_fetch_assoc($result)) {
        ...
        echo '<a id="'.$projects['project_name'].'_link" class="absolute cursor-pointer z-10 h-8 w-[8.5rem]" onclick="openProjectSidebar(`'.$projects['projectID'].'`, `'.$projects['project_name'].'`, `'.$projects['project_description'].'`)"></a>';
