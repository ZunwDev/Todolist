...
echo '          <div class="my-1 ml-4 w-full h-full font-bold select-none">Column edit</div>';
...
echo '              <label><strong>Column name</strong></label>';
...
echo '          </div>';
echo '          <div class="wrap mt-4 w-full h-full px-6 space-y-1 flex flex-col">';
echo '              <label><strong>Column description</strong></label>';
