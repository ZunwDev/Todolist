...
echo '            <div class="flex h-fit w-full flex-row my-1 gap-3 mx-2">';
echo '                <div class="h-fit w-full my-1">Manage task</div>';
echo '                <div class="flex my-1 h-fit">';
echo '                <div title="Close task manage" class="flex h-fit w-fit ml-auto px-2 py-2 rounded-lg hover:bg-slate-200 cursor-pointer" onclick="closeAnyPopup()"><svg class="flex w-3 h-3 " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M376.6 84.5c11.3-13.6 9.5-33.8-4.1-45.1s-33.8-9.5-45.1 4.1L192 206 56.6 43.5C45.3 29.9 25.1 28.1 11.5 39.4S-3.9 70.9 7.4 84.5L150.3 256 7.4 427.5c-11.3 13.6-9.5 33.8 4.1 45.1s33.8 9.5 45.1-4.1L192 306 327.4 468.5c11.3 13.6 31.5 15.4 45.1 4.1s15.4-31.5 4.1-45.1L233.7 256 376.6 84.5z"/></svg></div>';
echo '            </div>';
echo '        </div>';
echo '    </div>'; */
...
echo '        </div>';
echo '    <div class="flex flex-row py-1 ml bg-slate-100 hover:bg-slate-200 cursor-pointer" onclick="showTaskEditPopup(`' . $dataID . '`)">';
...
echo '            <div class="flex text-sm pl-2 py-1">Move to</div>';
echo '        </div>';
...
echo '            <div class="flex text-sm pl-2 py-1 text-red-600">Delete</div>';
echo '        </div>';
echo '    </div>';
echo '</div>';
