...
echo '<button id="opensidebar" title="Open/close" type="button" class="h-9 w-9 hover:bg-slate-100 transition ease-out duration-200 rounded-lg" onclick="expandSidebar()">';
...
if (!isset($_SESSION['login_user'])) {
    ...
    if ($adminState == 1) {
        echo '<li onclick="openDashboard()" class="flex text-gray-600 hover:bg-slate-200 py-2 cursor-pointer"><svg class="w-6 h-6 my-auto fill-gray-600 mr-2 ml-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 96C0 60.7 28.7 32 64 32H448c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V96zm64 64V416H224V160H64zm384 0H288V416H448V160z"/></svg>Dashboard</li>';
    }
