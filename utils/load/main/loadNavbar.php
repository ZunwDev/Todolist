<?php
echo '<nav class="app_navbarContainer h-fit shadow-bottom shadow-lg flex w-screen relative z-30">';
...
echo '<button id="opensidebar" title="Open/close" type="button" class="h-8 w-8 hover:bg-slate-100 transition ease-out duration-200 rounded-lg" onclick="expandSidebar()">';
